//
//  SILESLCommandDisconnectRunnerTestSpec.swift
//  BlueGeckoTests
//
...
class SILESLCommandDisconnectRunnerTestSpec: QuickSpec {
    var sut: SILESLCommandDisconnectRunner!
    var peripheralMock: CBPeripheral!
    var address: SILAddress!
    var commandMock: SILESLCommandDisconnectMock!
    ...
    override func spec() {
        beforeEach {
            ...
            self.commandMock = mock(SILESLCommandDisconnect.self).initialize(address: self.address)
            ...
            self.sut = SILESLCommandDisconnectRunner(peripheral: self.peripheralMock,
        ...
        describe("didUpdateValueFor:") {
            it("should receive callback without errors with value 0200") {
                var resultFromCommand: Result<Bool, SILESLCommandGenericError>!
                ...
                given(self.eslControlPointMock.value).willReturn(Data(bytes: [2, 0]))
            ...
            it("should receive callback without errors with value 0201") {
                var resultFromCommand: Result<Bool, SILESLCommandGenericError>!
            ...
            it("should drop message with wrong opcode") {
                ...
                given(self.eslControlPointMock.value).willReturn(Data(bytes: [0, 1]))
