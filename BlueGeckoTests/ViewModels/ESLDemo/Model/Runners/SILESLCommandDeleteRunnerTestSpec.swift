//
//  SILESLCommandDeleteRunnerTestSpec.swift
//  BlueGeckoTests
//
...
class SILESLCommandDeleteRunnerTestSpec: QuickSpec {
    var sut: SILESLCommandDeleteRunner!
    var peripheralMock: CBPeripheral!
    var address: SILAddress!
    var commandMock: SILESLCommandDeleteMock!
    ...
    override func spec() {
        beforeEach {
            ...
            self.commandMock = mock(SILESLCommandDelete.self).initialize(address: self.address)
            ...
            self.sut = SILESLCommandDeleteRunner(peripheral: self.peripheralMock,
        ...
        describe("didUpdateValueFor:") {
            it("should receive callback without errors with value 0900") {
                var resultFromCommand: Result<Bool, SILESLCommandGenericError>!
                ...
                given(self.eslControlPointMock.value).willReturn(Data(bytes: [9, 0]))
            ...
            it("should receive callback without errors with value 0901") {
                var resultFromCommand: Result<Bool, SILESLCommandGenericError>!
                ...
                given(self.eslControlPointMock.value).willReturn(Data(bytes: [9, 1]))
