//
//  SILESLCommandConnectRunnerTestSpec.swift
//  BlueGeckoTests
//
...
class SILESLCommandConnectRunnerTestSpec: QuickSpec {
    var sut: SILESLCommandConnectRunner!
    var peripheralMock: CBPeripheral!
    var address: SILAddress!
    var commandMock: SILESLCommandConnectMock!
    ...
    override func spec() {
        beforeEach {
            ...
            self.sut = SILESLCommandConnectRunner(peripheral: self.peripheralMock,
        ...
        describe("didUpdateValueFor:") {
            it("should receive callback without errors with value 0000") {
                var resultFromCommand: Result<Bool, SILESLCommandGenericError>!
                ...
                given(self.eslControlPointMock.value).willReturn(Data(bytes: [0, 0]))
            ...
            it("should receive callback without errors with value 0001") {
                var resultFromCommand: Result<Bool, SILESLCommandGenericError>!
