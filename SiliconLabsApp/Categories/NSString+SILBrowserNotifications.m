//
//  NSString+SILBrowserNotifications.m
//  BlueGecko
//
...
NSString * const SILNotificationReloadSavedSearchesViewHeight = @"ReloadSavedSearchesViewHeight";
NSString * const SILNotificationReloadFilterView = @"ReloadFilterView";
NSString * const SILNotificationRegisterLog = @"RegisterLog";
