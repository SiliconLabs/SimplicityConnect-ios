...
NSString * const SILAppBluetoothBrowserDetails = @"SILAppBluetoothBrowserDetails";
NSString * const SILAppBluetoothBrowserHome = @"SILAppBluetoothBrowser";

NSString * const SILSceneConnectedDevice = @"ConnectedDevice";
