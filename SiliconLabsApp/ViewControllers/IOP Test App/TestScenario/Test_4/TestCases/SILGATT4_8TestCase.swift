...
class SILGATT4_8TestCase: SILTestCase {
    var testID: String = "4.8"
    ...
    private lazy var notificationTestHelper = SILIOPGATTNotificationTestHelper(testCase: self,
                                                                               testedCharacteristicUUID: iopTestPropertiesNotifyLen255,
                                                                               exceptedValue: ExceptedValue,
                                                                               testedProperty: .notify)
    
    private var iopTestPropertiesNotifyLen255 = SILIOPPeripheral.SILIOPTestProperties.IOPTest_NotifyLen255.cbUUID
