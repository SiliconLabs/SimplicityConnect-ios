...
class SILGATT5_3TestCase: SILTestCase {
    var testID: String = "5.3"
    ...
    private lazy var lengthVariableTestHelper = SILIOPLengthVariableTestHelper(testCase: self,
                                                                               testedCharacteristicUUID: iopTestCharacteristicTypesRWVariableLen4,
                                                                               exceptedValue_Subtest1: ExceptedValue_Subtest1,
                                                                               exceptedValue_Subtest2: ExpectedValue_Subtest2)
    
    private var iopTestCharacteristicTypesRWVariableLen4 = SILIOPPeripheral.SILIOPTestCharacteristicTypes.IOPTestChar_RWVariableLen4.cbUUID
