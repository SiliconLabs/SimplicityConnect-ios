...
NSString * const kDeviceRetrievingErrorMessage = @"Error while retrieving device information. Please try again";
NSString * const kQuickStartGuide = @"A circuit board (SoC) must be connected and running “matter” firmware and a matter Hub. See Quick-Start Guide for more information.";
...
{
    uint64_t nextAvailableDeviceIdentifier = 200;
