...
class EHGraphXAxisRenderer: XAxisRenderer {
    ...
    override func computeAxisValues(min: Double, max: Double) {
        ...
        super.computeAxisValues(min: min, max: min + EHRSSIConstants.maxNumberOfVisibleXValues)
    }
...
class EHGraphXAxisValueFormatter: AxisValueFormatter {
